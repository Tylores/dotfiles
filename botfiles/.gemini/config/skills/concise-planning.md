...
3. **No Explanatory Prose:** Drop all conversational prefaces and post-list summaries. Output the checklist immediately and halt execution until the user gives the go-ahead.
